<section id="aseguradora" class="modal-box">
    <div class="modal-container">
      <div class="container mt-2">
        <div class="card mb-4">
          <div id="modal-content" class="card-body">
            <h2 id="modal_title" class="card-title">Agregar Nueva Compañia Aseguradora</h2>
            <form method="" action="" class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <textarea id="descripcionAseguradora" name="descripcionAseguradora" class="form-control" required></textarea>
              </div>
