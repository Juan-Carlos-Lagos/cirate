...
<head>
    ...
    {{-- Estilos modal de Usuarios/nuevo, radios/actualizar, Directorio/buscar, Reportes/UsoDelLugar,
    TipoPropiedad, CompañiaAseguradora --}}
    <link rel="stylesheet" href="{{ asset('css/modal.css')}}">

    {{-- Funcionamiento lista desplegable Usuarios, botón editar --}}
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="collapse nav flex-column ms-3 {{ $segment == 'radios' ? 'show' : '' }}" id="radioSubmenu">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('radios') }}" class="nav-link">Actualizar</a>
                            </li>
                        </ul>
                    </li>
